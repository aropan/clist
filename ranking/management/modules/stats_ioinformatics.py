...
class Statistic(BaseModule):
    ...
    def __init__(self, **kwargs):
        ...
        if not self.url.startswith('http://stats.ioinformatics.org/olympiads/'):
            raise InitModuleException(f'Url = {self.url} shoud be from stats.ioinformatics.org')
...
if __name__ == "__main__":
    statictic = Statistic(url='http://stats.ioinformatics.org/olympiads/1991', standings_url=None)
