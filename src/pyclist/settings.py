...
if DEBUG:
    ...
    def show_toolbar_callback(request):
        ...
        return (
            first_path not in DEBUG_PERMISSION_EXCLUDE_PATHS
            and not request.is_ajax()
            and "disable_dtb" not in request.GET
            and request.session.get("debug_toolbar")
            and (not DEBUG or request.user.is_authenticated)
        )
...
ALLOWED_REDIRECT_HOSTS_ = {
    "clist.by",
    "dev.clist.by",
    "grafana.clist.by",
    "bugsink.clist.by",
    "healthchecks.clist.by",
    "pgadmin.clist.by",
    "netdata.clist.by",
}
...
RESOURCE_RATING_CHART_CACHE_TIMEOUT = 5 * 60
RESOURCE_RATING_CHART_CACHE_LOCK_TIMEOUT = 60
...
FONTAWESOME_ICONS_ = {
    ...
    "fav": {
        "icon": '<i class="fa-fw fas fa-star activity fav selected-activity"></i>',
        "title": "Favorite",
        "name": "fa-star",
        "unselected_class": "far",
        "check_field": "is_favorite",
    },
    ...
    "tdo": {
        "icon": '<i class="fa-fw fas fa-calendar-day activity tdo"></i>',
        "name": "fa-calendar-day",
        "check_field": "is_todo",
    },
    "allsolved": {
        "icon": '<i class="fa-fw far fa-check-circle sol"></i>',
        "name": "fa-check-circle",
        "selected_class": "far",
        "unselected_class": "far",
    },
    "allreject": {
        "icon": '<i class="fa-fw far fa-times-circle rej"></i>',
    ...
    "n_participants": {
        "icon": '<i class="fa-fw fas fa-users"></i>',
        "title": "Number of participants",
        "position": "bottom",
    },
    "participation": '<i class="fa-fw fas fa-user-check"></i>',
    "n_problems": {
        "icon": '<i class="fa-fw fa-solid fa-list-check"></i>',
    ...
    "note": {
        "icon": '<i class="fa-fw far fa-edit"></i>',
        "name": "fa-edit",
        "check_field": "is_note",
        "selected_class": "far note-edit",
        "unselected_class": "far note-edit",
    },
