...
class Statistic(BaseModule):
    ...
    def get_standings(self, users=None, statistics=None, **kwargs):
        ...
        variables = {
            ...
            "selected_track": "CANONICAL",
            "min_rank": 50,
            "friends_only": False,
            "substring_filter": "",
            "country_filter": None,
            "should_show_friend_counts": False,
            "show_ranked_scoreboard": False,
        }
        ...
        if users or users is None:
            ...
            with PoolExecutor(max_workers=3) as executor:
                ...
                while paging_offset in process_pages:
                    paging_offset += 1
                parsed_percentage = paging_offset * 100.0 / n_page if n_page else None
        ...
        if not has_users_filter:
            ...
            if (
                parsed_percentage
                and parsed_percentage < 100
                and self.end_time < now() < self.end_time + timedelta(days=1)
            ):
