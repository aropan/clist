...
class Statistic(BaseModule):
    ...
    def get_standings(self, users=None, statistics=None, **kwargs):
        ...
        if "child_contests" in data:
            contest_infos = {d["contest_code"]: {"division": k} for k, d in data["child_contests"].items()}
        else:
                ...
                for url in urls:
                    ...
                    if n_total_page is None:
                        for p in data["problems"]:
                            ...
                            more_problem_info = self.get_problem_info(
                                problem_info, contest=self.contest, cache=problems_data
                            )
