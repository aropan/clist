...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--rating-update-delay", help="time delay after rating last update time", default="1 day")
    ...
    def handle(self, *args, **options):
        ...
        if not args.without_delay and not args.resources:
            ...
            need_update = Q(rank_update_time__isnull=True) | (
        ...
        for resource in tqdm(resources, total=len(resources), desc="resources"):
            ...
            with stream_event_log(event_log, self.logger):
                ...
                if with_rank_percentile:
                    ...
                    exclude.update({
                        "_percentile": FloatJSONF("info__rank_percentile"),
