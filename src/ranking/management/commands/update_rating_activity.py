        ...
        for resource in resource_progress:
            ...
            with logging_event(
                ...
                accounts = (
                    ...
                    .annotate(
                        stat_rating_activity=Greatest("statistics__last_activity", "statistics__contest__start_time")
                    )
                    .values_list("pk")
                    ...
                    .filter(
                        Q(last_rating_activity__isnull=True)
                        | Q(rating_activity__isnull=True)
                ...
                update_accounts = [
                    Account(pk=pk, last_rating_activity=rating_activity) for pk, rating_activity in accounts
                ]
