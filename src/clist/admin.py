...
class ContestAdmin(BaseModelAdmin):
    ...
    fieldsets = [
        ...
        [
            ...
            {
                "fields": [
                    "statistics_update_required",
                    "parsed_time",
                    "parsed_percentage",
                    "wait_for_successful_update_timing",
                    "statistic_timing",
                    "notification_timing",
        ...
        [
            "Rating",
            {"fields": ["rating_prediction_hash", "has_fixed_rating_prediction_field", "rating_prediction_fields"]},
        ],
        [
            "Problem",
            {
                "fields": [
                    "n_problems",
                    "problem_rating_hash",
                    "problem_rating_update_required",
                    "hide_unsolved_standings_problems",
                    "upload_solved_problems_solutions",
                ]
            },
        ],
...
class ResourceAdmin(BaseModelAdmin):
    ...
    fieldsets = [
        ...
        [
            "Rating information",
            {
                "fields": [
                    ...
                    "avg_rating",
                    "n_rating_accounts",
                    "n_university_accounts",
                    "n_team_accounts",
                    "rating_update_time",
                    "rank_update_time",
                    "contest_update_time",
                    "country_rank_update_time",
                    "ratings",
                    "rating_prediction",
                    "has_statistic_total_solving",
        ...
        [
            "Account information",
            {
                "fields": [
                    ...
                    "has_accounts_infos_update",
                    "n_accounts_to_update",
                    "has_multi_account",
                    "has_account_verification",
                    "has_standings_renamed_account",
                    "skip_for_contests_chart",
                    "accounts_fields",
                ]
            },
        ],
        [
            "Problem information",
            {
                "fields": [
                    "has_problem_rating",
                    "has_problem_update",
                    "has_problem_statistic",
                    "has_problem_archive",
                    "problem_archive_update_time",
                    "has_upsolving",
                    "problems_fields",
        ...
        [
            ...
            {"fields": ["allow_delete_archived_statistics", "has_submissions_statistics_log", "statistics_fields"]},
        ],
    ...
    list_display = [
        ...
        "_has_profile_url",
        "_has_problem_rating",
        "_has_accounts_infos_update",
        "_has_multi_account",
        "_has_standings_renamed_account",
        "_has_upsolving",
        "_has_verification",
    ]
