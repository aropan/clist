...
class ContestAdmin(BaseModelAdmin):
    ...
    fieldsets = [
        [None, {'fields': ['title', 'slug', 'title_path', 'kind', 'resource', 'host', 'url', 'standings_url',
                           ...
                           'upsolving_url', 'upsolving_key', 'has_unlimited_statistics']}],
...
class ResourceAdmin(BaseModelAdmin):
    ...
    fieldsets = [
        [None, {'fields': ['host', 'short_host', 'enable', 'url', 'profile_url', 'avatar_url', 'problem_url',
                           'icon_file', 'icon_url', 'icon_updated_at',
        ...
        ['Rating information', {'fields': ['has_rating_history', 'has_country_rating',
                                           'avg_rating', 'n_rating_accounts', 'n_university_accounts', 'n_team_accounts',
                                           ...
                                           'has_country_medal', 'has_country_place']}],
        ['Account information', {'fields': ['default_account_type', 'has_accounts_infos_update', 'n_accounts_to_update',
                                            'has_multi_account', 'has_account_verification',
                                            'has_standings_renamed_account', 'skip_for_contests_chart',
                                            'accounts_fields']}],
